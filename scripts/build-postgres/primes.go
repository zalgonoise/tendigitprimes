...
func readPrimes(ctx context.Context, logger *slog.Logger, dir string) ([][]any, error) {
	...
	total := make([][]any, 0, len(entries)*maxAlloc)
...
func extract(ctx context.Context, logger *slog.Logger, path string) ([][]any, error) {
